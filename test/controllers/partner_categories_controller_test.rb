...
class PartnerCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner_category" do
    assert_difference("PartnerCategory.count") do
      post partner_categories_url, params: { partner_category: { desc: @partner_category.desc, image_data: @partner_category.image_data, name: @partner_category.name } }
    end
  ...
  test "should update partner_category" do
    patch partner_category_url(@partner_category), params: { partner_category: { desc: @partner_category.desc, image_data: @partner_category.image_data, name: @partner_category.name } }
  ...
  test "should destroy partner_category" do
    ...
    assert_redirected_to partner_categories_url
  end
end
