...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference("Partner.count") do
      post partners_url, params: { partner: { desc: @partner.desc, image_data: @partner.image_data, name: @partner.name, position: @partner.position, url: @partner.url } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { desc: @partner.desc, image_data: @partner.image_data, name: @partner.name, position: @partner.position, url: @partner.url } }
